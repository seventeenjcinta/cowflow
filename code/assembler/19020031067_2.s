...
c/19020031067_2.elf:     file format elf64-x86-64
...
00000000004006b0 <print>:
  ...
  4006b7:	74 28                	je     4006e1 <print+0x31>
  ...
  4006cc:	bf d4 0a 40 00       	mov    $0x400ad4,%edi
  4006d1:	b0 01                	mov    $0x1,%al
  4006d3:	e8 a8 fe ff ff       	callq  400580 <printf@plt>
  4006d8:	48 8b 5b 10          	mov    0x10(%rbx),%rbx
  4006dc:	48 85 db             	test   %rbx,%rbx
  4006df:	75 df                	jne    4006c0 <print+0x10>
  4006e1:	5b                   	pop    %rbx
  4006e2:	c3                   	retq   
...
00000000004006f0 <insert>:
  ...
  4006f3:	74 25                	je     40071a <insert+0x2a>
  4006f5:	48 8b 16             	mov    (%rsi),%rdx
  4006f8:	48 3b 17             	cmp    (%rdi),%rdx
  4006fb:	7e 24                	jle    400721 <insert+0x31>
  4006fd:	48 89 f8             	mov    %rdi,%rax
  400700:	48 89 c1             	mov    %rax,%rcx
  400703:	48 8b 41 10          	mov    0x10(%rcx),%rax
  400707:	48 85 c0             	test   %rax,%rax
  40070a:	74 1d                	je     400729 <insert+0x39>
  40070c:	48 3b 10             	cmp    (%rax),%rdx
  40070f:	7f ef                	jg     400700 <insert+0x10>
  400711:	48 89 71 10          	mov    %rsi,0x10(%rcx)
  400715:	48 89 f1             	mov    %rsi,%rcx
  400718:	eb 12                	jmp    40072c <insert+0x3c>
  40071a:	31 c0                	xor    %eax,%eax
  40071c:	48 89 f1             	mov    %rsi,%rcx
  40071f:	eb 0e                	jmp    40072f <insert+0x3f>
  400721:	48 89 f1             	mov    %rsi,%rcx
  400724:	48 89 f8             	mov    %rdi,%rax
  400727:	eb 06                	jmp    40072f <insert+0x3f>
  400729:	48 89 f0             	mov    %rsi,%rax
  40072c:	48 89 fe             	mov    %rdi,%rsi
  40072f:	48 89 41 10          	mov    %rax,0x10(%rcx)
  400733:	48 89 f0             	mov    %rsi,%rax
  400736:	c3                   	retq   
...
0000000000400750 <del>:
  ...
  400772:	bf 2f 0b 40 00       	mov    $0x400b2f,%edi
  ...
  4007b7:	bf 50 0b 40 00       	mov    $0x400b50,%edi
...
00000000004007d0 <main>:
  ...
  4007e8:	bf 90 0b 40 00       	mov    $0x400b90,%edi
  ...
  400810:	bf c0 0b 40 00       	mov    $0x400bc0,%edi
  ...
  400972:	bf 2f 0b 40 00       	mov    $0x400b2f,%edi
  ...
  4009e6:	bf 50 0b 40 00       	mov    $0x400b50,%edi
