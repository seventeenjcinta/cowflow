...
input/19020031122_2.elf:     file format elf64-x86-64
...
00000000000006f0 <main>:
 6f0:	41 57                	push   %r15
 6f2:	41 56                	push   %r14
 6f4:	48 8d 3d 9c 05 00 00 	lea    0x59c(%rip),%rdi        # c97 <_IO_stdin_used+0x57>
 6fb:	41 55                	push   %r13
 6fd:	41 54                	push   %r12
 6ff:	4c 8d 25 c0 05 00 00 	lea    0x5c0(%rip),%r12        # cc6 <_IO_stdin_used+0x86>
 706:	55                   	push   %rbp
 707:	53                   	push   %rbx
 ...
 746:	48 8d 3d 68 05 00 00 	lea    0x568(%rip),%rdi        # cb5 <_IO_stdin_used+0x75>
 ...
 760:	48 8d 3d 74 05 00 00 	lea    0x574(%rip),%rdi        # cdb <_IO_stdin_used+0x9b>
 ...
 783:	48 8d 35 71 05 00 00 	lea    0x571(%rip),%rsi        # cfb <_IO_stdin_used+0xbb>
 78a:	bf 01 00 00 00       	mov    $0x1,%edi
 78f:	31 c0                	xor    %eax,%eax
 791:	e8 2a ff ff ff       	callq  6c0 <__printf_chk@plt>
 796:	48 8d 3d 5a 05 00 00 	lea    0x55a(%rip),%rdi        # cf7 <_IO_stdin_used+0xb7>
 79d:	48 89 ee             	mov    %rbp,%rsi
 7a0:	31 c0                	xor    %eax,%eax
 7a2:	e8 29 ff ff ff       	callq  6d0 <__isoc99_scanf@plt>
 7a7:	48 8d 35 66 05 00 00 	lea    0x566(%rip),%rsi        # d14 <_IO_stdin_used+0xd4>
 ...
 7ed:	00 00 00 
 7f0:	48 8d 35 e7 04 00 00 	lea    0x4e7(%rip),%rsi        # cde <_IO_stdin_used+0x9e>
 7f7:	bf 01 00 00 00       	mov    $0x1,%edi
 7fc:	31 c0                	xor    %eax,%eax
 7fe:	e8 bd fe ff ff       	callq  6c0 <__printf_chk@plt>
 803:	48 8d 3d ed 04 00 00 	lea    0x4ed(%rip),%rdi        # cf7 <_IO_stdin_used+0xb7>
...
0000000000000b60 <print>:
 b60:	55                   	push   %rbp
 b61:	53                   	push   %rbx
 b62:	48 8d 35 15 01 00 00 	lea    0x115(%rip),%rsi        # c7e <_IO_stdin_used+0x3e>
 b69:	48 89 fb             	mov    %rdi,%rbx
 b6c:	31 c0                	xor    %eax,%eax
 b6e:	bf 01 00 00 00       	mov    $0x1,%edi
 b73:	48 83 ec 08          	sub    $0x8,%rsp
 b77:	8b 15 97 14 20 00    	mov    0x201497(%rip),%edx        # 202014 <n>
 b7d:	e8 3e fb ff ff       	callq  6c0 <__printf_chk@plt>
 b82:	48 85 db             	test   %rbx,%rbx
 b85:	74 30                	je     bb7 <print+0x57>
 b87:	48 8d 2d fd 00 00 00 	lea    0xfd(%rip),%rbp        # c8b <_IO_stdin_used+0x4b>
 ...
 ba9:	e8 12 fb ff ff       	callq  6c0 <__printf_chk@plt>
 bae:	48 8b 5b 10          	mov    0x10(%rbx),%rbx
 bb2:	48 85 db             	test   %rbx,%rbx
 bb5:	75 d9                	jne    b90 <print+0x30>
 bb7:	48 83 c4 08          	add    $0x8,%rsp
 bbb:	5b                   	pop    %rbx
 bbc:	5d                   	pop    %rbp
 bbd:	c3                   	retq   
