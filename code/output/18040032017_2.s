...
input/18040032017_2.elf:     file format elf64-x86-64
...
0000000000000790 <main>:
 790:	41 55                	push   %r13
 792:	41 54                	push   %r12
 794:	48 8d 3d 2e 05 00 00 	lea    0x52e(%rip),%rdi        # cc9 <_IO_stdin_used+0x49>
 79b:	55                   	push   %rbp
 79c:	53                   	push   %rbx
 ...
 7e5:	48 8d 35 4f 05 00 00 	lea    0x54f(%rip),%rsi        # d3b <_IO_stdin_used+0xbb>
 7ec:	bf 01 00 00 00       	mov    $0x1,%edi
 7f1:	31 c0                	xor    %eax,%eax
 7f3:	e8 68 ff ff ff       	callq  760 <__printf_chk@plt>
 7f8:	48 8d 3d 4e 05 00 00 	lea    0x54e(%rip),%rdi        # d4d <_IO_stdin_used+0xcd>
 ...
 82d:	48 8d 3d ac 04 00 00 	lea    0x4ac(%rip),%rdi        # ce0 <_IO_stdin_used+0x60>
 834:	e8 e7 fe ff ff       	callq  720 <puts@plt>
 839:	48 8d 35 ba 04 00 00 	lea    0x4ba(%rip),%rsi        # cfa <_IO_stdin_used+0x7a>
 ...
 854:	48 8d 3d ae 04 00 00 	lea    0x4ae(%rip),%rdi        # d09 <_IO_stdin_used+0x89>
 ...
 87e:	48 8d 35 87 04 00 00 	lea    0x487(%rip),%rsi        # d0c <_IO_stdin_used+0x8c>
 ...
 89b:	48 8d 3d 86 04 00 00 	lea    0x486(%rip),%rdi        # d28 <_IO_stdin_used+0xa8>
 ...
 8c2:	48 8d 35 65 04 00 00 	lea    0x465(%rip),%rsi        # d2e <_IO_stdin_used+0xae>
...
0000000000000b10 <create>:
 ...
 b20:	48 8d 3d 9b 01 00 00 	lea    0x19b(%rip),%rdi        # cc2 <_IO_stdin_used+0x42>
 ...
 b3e:	4c 8d 25 7d 01 00 00 	lea    0x17d(%rip),%r12        # cc2 <_IO_stdin_used+0x42>
...
0000000000000b90 <del>:
 ...
 b96:	75 13                	jne    bab <del+0x1b>
 b98:	eb 46                	jmp    be0 <del+0x50>
 b9a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
 ba0:	48 85 d2             	test   %rdx,%rdx
 ba3:	48 89 f9             	mov    %rdi,%rcx
 ba6:	74 40                	je     be8 <del+0x58>
 ba8:	48 89 d7             	mov    %rdx,%rdi
 bab:	48 39 37             	cmp    %rsi,(%rdi)
 bae:	48 8b 57 10          	mov    0x10(%rdi),%rdx
 bb2:	75 ec                	jne    ba0 <del+0x10>
 bb4:	48 83 ec 18          	sub    $0x18,%rsp
 bb8:	48 39 c7             	cmp    %rax,%rdi
 bbb:	74 33                	je     bf0 <del+0x60>
 bbd:	48 89 51 10          	mov    %rdx,0x10(%rcx)
 bc1:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
 bc6:	e8 45 fb ff ff       	callq  710 <free@plt>
 bcb:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
 bd0:	83 2d 45 14 20 00 01 	subl   $0x1,0x201445(%rip)        # 20201c <n>
 bd7:	48 83 c4 18          	add    $0x18,%rsp
 bdb:	c3                   	retq   
 ...
 bf0:	48 89 d0             	mov    %rdx,%rax
 bf3:	eb cc                	jmp    bc1 <del+0x31>
 bf5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
 bfc:	00 00 00 
 bff:	90                   	nop
