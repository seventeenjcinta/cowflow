...
input/19020031100_2.elf:     file format elf64-x86-64
...
0000000000000790 <main>:
 790:	41 56                	push   %r14
 792:	41 55                	push   %r13
 794:	48 8d 3d 1a 06 00 00 	lea    0x61a(%rip),%rdi        # db5 <_IO_stdin_used+0x45>
 79b:	41 54                	push   %r12
 79d:	55                   	push   %rbp
 79e:	53                   	push   %rbx
 ...
 7b8:	48 8d 3d 51 06 00 00 	lea    0x651(%rip),%rdi        # e10 <_IO_stdin_used+0xa0>
 ...
 7ed:	48 8d 35 03 06 00 00 	lea    0x603(%rip),%rsi        # df7 <_IO_stdin_used+0x87>
 7f4:	bf 01 00 00 00       	mov    $0x1,%edi
 7f9:	31 c0                	xor    %eax,%eax
 7fb:	e8 60 ff ff ff       	callq  760 <__printf_chk@plt>
 800:	48 8d 3d 05 06 00 00 	lea    0x605(%rip),%rdi        # e0c <_IO_stdin_used+0x9c>
 ...
 835:	48 8d 3d 90 05 00 00 	lea    0x590(%rip),%rdi        # dcc <_IO_stdin_used+0x5c>
 83c:	e8 df fe ff ff       	callq  720 <puts@plt>
 841:	48 8d 3d 9e 05 00 00 	lea    0x59e(%rip),%rdi        # de6 <_IO_stdin_used+0x76>
 ...
 873:	48 8d 35 be 05 00 00 	lea    0x5be(%rip),%rsi        # e38 <_IO_stdin_used+0xc8>
 ...
 890:	48 8d 3d f5 04 00 00 	lea    0x4f5(%rip),%rdi        # d8c <_IO_stdin_used+0x1c>
 ...
 8ee:	48 8d 35 f4 04 00 00 	lea    0x4f4(%rip),%rsi        # de9 <_IO_stdin_used+0x79>
...
0000000000000ba0 <create>:
 ...
 bb7:	48 8d 3d ce 01 00 00 	lea    0x1ce(%rip),%rdi        # d8c <_IO_stdin_used+0x1c>
 ...
 bd7:	4c 8d 25 ae 01 00 00 	lea    0x1ae(%rip),%r12        # d8c <_IO_stdin_used+0x1c>
...
0000000000000c80 <print>:
 ...
 c85:	55                   	push   %rbp
 c86:	53                   	push   %rbx
 c87:	48 8d 2d 05 01 00 00 	lea    0x105(%rip),%rbp        # d93 <_IO_stdin_used+0x23>
 ...
 ccd:	00 00 00 
 cd0:	48 8d 35 c7 00 00 00 	lea    0xc7(%rip),%rsi        # d9e <_IO_stdin_used+0x2e>
